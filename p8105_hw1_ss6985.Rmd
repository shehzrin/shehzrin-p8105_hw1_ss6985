...
Conversion to numeric works by translating **factor** levels to integers (explains why you can calculate the mean of factors if converted to numeric). However, the mean of these integer codes might not be meaningful in a categorical context.